    ...
    <div className="flex flex-col gap-24 pb-24">
      ...
      <section className="relative min-h-[90vh] py-24 md:py-32 flex items-center justify-center">
        ...
        <div className="container relative z-10 px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed min-h-[4em] md:min-h-[3em]">
            {displayText}
            {showCursor && <span className="animate-pulse border-r-2 border-primary ml-1"></span>}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href="/jobs" className="w-full sm:w-auto">
              <Button size="lg" className="w-full h-16 px-10 text-lg font-black gap-2 gold-border-glow rounded-2xl">
                Explore Jobs <ArrowRight className="w-5 h-5" />
              </Button>
            </Link>
            <Link href="/auth#signup" className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="w-full h-16 px-10 text-lg font-bold border-white/10 hover:bg-white/5 rounded-2xl backdrop-blur-sm">
                Join as Employer
              </Button>
            </Link>
          </div>
      ...
      {/* Feature Grids */}
      <section className="container px-4 mx-auto relative z-20 -mt-12 md:-mt-24">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="glass-card p-10 rounded-4xl flex flex-col gap-6 group hover:border-primary/50 transition-all duration-500 shadow-2xl">
            ...
            <div>
              ...
              <Link href="/auth#signup">
                <Button variant="secondary" className="w-full sm:w-auto h-12 px-8 font-black rounded-xl">Start Your Career</Button>
              </Link>
            </div>
          </div>
          ...
          <div className="glass-card p-10 rounded-4xl flex flex-col gap-6 group hover:border-primary/50 transition-all duration-500 shadow-2xl">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-3 text-sm font-bold"><ShieldCheck className="w-4 h-4 text-primary" /> Seamless job posting</li>
                <li className="flex items-center gap-3 text-sm font-bold"><ShieldCheck className="w-4 h-4 text-primary" /> Applicant management system</li>
                <li className="flex items-center gap-3 text-sm font-bold"><ShieldCheck className="w-4 h-4 text-primary" /> Collaborative hiring tools</li>
              </ul>
              <Link href="/auth#signup">
                <Button variant="secondary" className="w-full sm:w-auto h-12 px-8 font-black rounded-xl">Post a Vacancy</Button>
              </Link>
            </div>
          </div>
        </div>
